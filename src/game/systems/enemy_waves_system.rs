...
use crate::{Abort, DRAW_COLORS, entities_with, get_components_clone_unwrap, get_components_unwrap, has_all_components, int_to_string, rect, Registry, SCREEN_SIZE, text, Vec2};
...
impl System for EnemyWavesSystem {
    fn execute_system(&mut self, registry: &mut Registry) {
        ...
        text(int_to_string(self.current_wave as i32), 8 * wave_text_len, bottom_screen);
