...
pub fn init_sprinter(registry: &mut Registry, e: Entity) {
    ...
    registry.add_component(e, SpriteComponent { sprite: &GRASS_SPRITE, zindex: 2 }).abort();
...
pub fn init_fly(registry: &mut Registry, e: Entity) {
    ...
    registry.add_component(e, SizeComponent { width: 8, height: 8 }).abort();
    registry.add_component(e, SpriteComponent { sprite: &FLY_SPRITE, zindex: 2 }).abort();
...
pub fn init_spitworm(registry: &mut Registry, e: Entity) {
    ...
    registry.add_component(e, SizeComponent { width: 8, height: 8 }).abort();
    registry.add_component(e, SpriteComponent { sprite: &SPITWORM_SPRITE, zindex: 2 }).abort();
    registry.add_component(e, ScoreComponent { score: 20 }).abort();
}
